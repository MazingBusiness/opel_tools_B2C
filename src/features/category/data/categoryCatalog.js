...
function product(id, title, photo, rating, reviewCount, current, original) {
  const catalogId = id.replace(/^([a-z]+)-p(\d+)$/, '$1-$2')
...
const powerToolsProducts = [
  product('pt-1', '18V Brushless Cordless Drill Kit with 2 Batteries', IMG.drill, 4.7, 251, 4699, 7999),
  product('pt-2', 'Heavy-Duty Angle Grinder 850W', IMG.grinder, 4.5, 128, 2499, 3999),
  product('pt-3', 'Compact Circular Saw 1400W with Laser Guide', IMG.saw, 4.6, 89, 5899, 8499),
  product('pt-4', 'Impact Driver Set 12V with Bits Case', IMG.impact, 4.8, 312, 3299, 5499),
  product('pt-5', 'Rotary Hammer Drill SDS-Plus 800W', IMG.workshop, 4.4, 76, 6799, 9999),
  product('pt-6', 'Jigsaw with Variable Speed & LED Light', IMG.bench, 4.3, 54, 2199, 3499),
  product('pt-7', 'Bench Grinder Dual Wheel 150mm', IMG.industrial, 4.5, 41, 2899, 4199),
  product('pt-8', 'Reciprocating Saw Corded 850W', IMG.toolbox, 4.2, 33, 3599, 5299),
  product('pt-9', 'Multi-Tool Oscillating Kit 300W', IMG.multi, 4.6, 97, 4199, 6499),
  product('pt-10', '18V Compact Drill Driver Soft Grip', IMG.drill, 4.5, 184, 2899, 4499),
  product('pt-11', 'Die Grinder 25,000 RPM Corded', IMG.grinder, 4.3, 62, 1999, 3199),
  product('pt-12', 'Cut-off Saw 355mm Abrasive', IMG.saw, 4.4, 48, 8999, 12999),
  product('pt-13', 'Brushless Impact Wrench 1/2-Inch', IMG.impact, 4.7, 203, 5499, 7999),
  product('pt-14', 'Cordless Combo Kit 4-Tool 18V', IMG.workshop, 4.8, 410, 12999, 18999),
  product('pt-15', 'Planer Corded 82mm Depth Gauge', IMG.bench, 4.2, 29, 4599, 6999),
  product('pt-16', 'Orbital Sander 125mm Dust Port', IMG.industrial, 4.5, 117, 1899, 2999),
  product('pt-17', 'Heat Gun Dual Temp Kit', IMG.toolbox, 4.3, 88, 1499, 2499),
  product('pt-18', 'Router Plunge Base 1200W', IMG.multi, 4.6, 71, 6299, 8999),
  product('pt-19', 'Cordless Nailer Framing 18V', IMG.battery, 4.4, 95, 7899, 11499),
  product('pt-20', 'Shop Vacuum Wet Dry 20L', IMG.workshop, 4.5, 143, 3999, 5999),
]

const cordlessDrillProducts = [
  product('pt-21', '18V Brushless Compact Drill 2×2.0Ah', IMG.drill, 4.8, 320, 4299, 6999),
  product('pt-22', '12V Pocket Drill Driver Kit', IMG.impact, 4.6, 198, 2799, 4299),
  product('pt-23', '20V Max Hammer Drill SDS Lite', IMG.workshop, 4.7, 156, 5999, 8999),
  product('pt-24', 'Brushless Drill + Impact Combo', IMG.bench, 4.9, 445, 8499, 12999),
  product('pt-25', 'Heavy-Duty 18V Drill 80Nm Torque', IMG.industrial, 4.5, 112, 5199, 7799),
  product('pt-26', 'Compact Drill Soft Case Single Battery', IMG.toolbox, 4.4, 87, 2499, 3999),
  product('pt-27', 'Hammer Cordless 18V Masonry Ready', IMG.grinder, 4.6, 134, 6499, 9499),
  product('pt-28', 'Pro Brushless Drill Bare Tool', IMG.saw, 4.7, 201, 3599, 5499),
  product('pt-29', 'Drill Kit 100-Piece Accessory Pack', IMG.multi, 4.5, 267, 1899, 2999),
  product('pt-30', 'Right-Angle Compact Drill 12V', IMG.battery, 4.3, 54, 3999, 5999),
  product('pt-21', '18V Drill Driver LED Work Light', IMG.drill, 4.6, 173, 3099, 4799),
  product('pt-22', 'Brushless Twin Pack Drill & Driver', IMG.impact, 4.8, 298, 9999, 14999),
  product('pt-23', 'Starter Cordless Drill 10mm Chuck', IMG.workshop, 4.2, 91, 1699, 2799),
  product('pt-24', 'Pro Hammer Drill Dual Speed', IMG.bench, 4.7, 142, 7299, 10999),
  product('pt-25', 'Compact Brushless 40Nm Kit', IMG.industrial, 4.5, 119, 4599, 6999),
  product('pt-26', 'Jobsite Drill Combo Soft Bag', IMG.toolbox, 4.6, 188, 7899, 11499),
  product('pt-27', 'Keyless Chuck Upgrade Drill 18V', IMG.grinder, 4.4, 66, 3399, 5199),
  product('pt-28', 'All-Terrain Cordless Drill IP54', IMG.saw, 4.5, 78, 5699, 8499),
  product('pt-29', '18V Drill with Extra Battery & Charger', IMG.battery, 4.6, 164, 5499, 8299),
  product('pt-30', 'Brushless Compact Drill Soft Bag Kit', IMG.multi, 4.7, 211, 6299, 9499),
]
  ...
  'power-tools': {
    ...
    childSpotlights: [
      ...
      },
      {
        ...
        products: [
          product('pt-2', 'Heavy-Duty Angle Grinder 850W', IMG.grinder, 4.5, 128, 2499, 3999),
          product('pt-11', 'Die Grinder 25,000 RPM Corded', IMG.workshop, 4.4, 92, 1899, 2999),
          product('pt-16', 'Orbital Sander 125mm Dust Port', IMG.bench, 4.6, 74, 4299, 6499),
          product('pt-12', 'Cut-off Saw 355mm Abrasive', IMG.industrial, 4.3, 61, 3199, 4799),
          product('pt-2', 'Heavy-Duty Angle Grinder 850W', IMG.toolbox, 4.4, 88, 2799, 4199),
          product('pt-11', 'Die Grinder 25,000 RPM Corded', IMG.drill, 4.2, 52, 1599, 2499),
          product('pt-16', 'Orbital Sander 125mm Dust Port', IMG.saw, 4.5, 71, 3499, 5299),
          product('pt-12', 'Cut-off Saw 355mm Abrasive', IMG.multi, 4.3, 44, 2299, 3599),
        ],
      },
      {
        ...
        products: [
          product('pt-4', 'Impact Driver Set 12V with Bits Case', IMG.impact, 4.8, 312, 3299, 5499),
          product('pt-13', 'Brushless Impact Wrench 1/2-Inch', IMG.drill, 4.7, 188, 4999, 7499),
          product('pt-10', '18V Compact Drill Driver Soft Grip', IMG.bench, 4.5, 104, 2799, 4199),
          product('pt-4', 'Impact Driver Set 12V with Bits Case', IMG.toolbox, 4.6, 156, 3599, 5499),
          product('pt-13', 'Brushless Impact Wrench 1/2-Inch', IMG.workshop, 4.4, 97, 2999, 4599),
          product('pt-10', '18V Compact Drill Driver Soft Grip', IMG.industrial, 4.5, 83, 3899, 5799),
          product('pt-14', 'Cordless Combo Kit 4-Tool 18V', IMG.saw, 4.7, 201, 8999, 12999),
          product('pt-4', 'Impact Driver Set 12V with Bits Case', IMG.multi, 4.3, 66, 4199, 6299),
        ],
      },
    ],
