...
/**
 * Shared promotional hero carousel (Embla + autoplay).
 * @param {{
 *   slides: Array<{ id: string, imageUrl: string, linkUrl?: string }>,
 *   label?: string,
 * }} props
 */
export default function HeroCarousel({ slides, label = 'Promotional banners' }) {
